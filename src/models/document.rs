...
impl Document {
    ...
    ///
    /// Fetch all the documents of a paste, and combine the size of the documents.
    ///
    /// ## Arguments
    ///
    /// - `db` - The database to make the request to.
    ...
    pub async fn fetch_total_document_size(
        ...
        let result: i64 = sqlx::query_scalar!(
            "SELECT SUM(size)::BIGINT AS total_size FROM documents WHERE paste_id = $1;",
            id,
        )
        .fetch_one(db.pool())
        .await?
    ...
    ///
    /// Fetch all the documents of a paste, and count up the amount.
    ///
    /// ## Arguments
    ///
    /// - `db` - The database to make the request to.
    ...
    pub async fn fetch_total_document_count(
        ...
        let result: i64 = sqlx::query_scalar!(
            "SELECT COUNT(*) AS total_count FROM documents WHERE paste_id = $1;",
            id,
        )
        .fetch_one(db.pool())
        .await?
